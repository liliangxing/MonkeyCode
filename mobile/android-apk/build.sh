...
# MonkeyCode APK Build Script
# Uses Android SDK build-tools directly (no Gradle needed)

export JAVA_HOME=/data/user/work/jdk-17.0.13+11
...
PROJECT=/data/user/work/monkeyCode-apk
APP_DIR=$PROJECT/app
...
# Convert ALL Java classes (including inner classes) to DEX
